...
<head>
    ...
    <meta name="description" content="PaySwif To Track Your Money" />
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 animate-box" data-animate-effect="fadeIn">
                    <div class="gtco-staff">
                        ...
                        <h3>Fatima Alawadh</h3>
                        <strong class="role">Solution Architect</strong>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 animate-box" data-animate-effect="fadeIn">
                    <div class="gtco-staff">
                        <img src="images/person_1.jpg" alt="Free HTML5 Templates by gettemplates.co">
                        <h3>Lara Alfaraj</h3>
                        <strong class="role">Penetration Tester</strong>
                    </div>
                </div>
                <div class="clearfix visible-sm-block"></div>
                <div class="col-lg-4 col-md-4 col-sm-6 animate-box" data-animate-effect="fadeIn">
                ...
                <div class="col-md-12">
                    ...
                    <p class="pull-right">
                        <ul class="gtco-social-icons pull-right">
                            ...
                            <li><a href="mailto:comPaySwif@gmail.com"><i class="icon-mail2"></i></a></li>
