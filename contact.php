				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc">
							...
							<h2 class="animate-box" data-animate-effect="fadeInUp"><em>Your voice matters! <br></br></em> Reach out and let us know how we can make your experience better </h2>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row row-pb-md">
					...
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
						...
						<div class="row form-group">
							<div class="col-md-12">
                            	...
                            	<textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="Tell us more"></textarea>
							</div>
						</div>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="address">198 West 21th Street, <br> Suite 721 Saudi Arabia 10016</li>
							<li class="phone"><a href="tel://966595372380">+966595372380</a></li>
							<li class="email"><a href="mailto:comPaySwift@gmail.com">PaySwift@gmail.com</a></li>
						</ul>
					</div>
				...
				<div class="col-md-4">
					<div class="gtco-widget">
						...
						<ul class="gtco-quick-contact">
                        	...
                        	<li><a href="mailto:PaySwift@gmail.com"><i class="icon-mail2"></i> PaySwift@gmail.com</a></li>
						</ul>
					</div>
				</div>
...
<?php
// PHP script to handle form submission and save feedback to a text file
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Specify the file to save the feedback
    $file = "feedback.txt"; // Change the file path as needed

    // Save feedback to the file
    if (file_put_contents($file, $feedback, FILE_APPEND | LOCK_EX) !== false) {
        echo "<script>alert('Thank you for your feedback!');</script>"; // Feedback to the user
    } else {
        echo "<script>alert('Unable to save feedback. Please try again later.');</script>"; // Error message
    }
}
?>
